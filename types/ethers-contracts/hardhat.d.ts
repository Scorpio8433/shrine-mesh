...
getContractFactory(name: 'VaultSteward', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.VaultSteward__factory>

  getContractAt(name: 'Counter', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.Counter>
getContractAt(name: 'VaultSteward', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.VaultSteward>

  deployContract(name: 'Counter', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'VaultSteward', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.VaultSteward>

  deployContract(name: 'Counter', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'VaultSteward', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.VaultSteward>
